...
class HomeController extends Controller
{
    ...
    {
        $seo = [
            'title' => 'Our Portfolio - ' . config('app.name'),
            'description' => 'Explore our portfolio of successful projects and case studies. See how we have helped our clients achieve their goals.',
        ];
        return view('pages.home.portfolio', compact('seo'));

    }
    public function careers()
    {
        $seo = [
            'title' => 'Careers at ' . config('app.name'),
            'description' => 'Join the team at ' . config('app.name') . '. Explore our current job openings and career opportunities.',
        ];
        return view('pages.home.careers', compact('seo'));
