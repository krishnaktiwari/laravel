...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('kshititech::pages.home.index', compact('seo'));
    }
    public function about_us()
    {
        $seo = [
            ...
            'og_type' => 'website',
            'image' => asset('assets/kshititech/images/about-us-og.png'),
        ];

        return view('kshititech::pages.home.about-us', compact('seo'));
    }
    public function contact_us()
    {
        ...
        $seo = [
            ...
            'og_type' => 'website',
            'image' => asset('assets/kshititech/images/contact-us-og.png'),
        ];
        return view('kshititech::pages.home.contact-us', compact('seo'));
    }
    ...
    public function portfolio()
    {
        $seo = [
            ...
            'og_type' => 'website',
            'image' => asset('assets/kshititech/images/portfolio-og.png'),
        ];
        return view('kshititech::pages.home.portfolio', compact('seo'));
    }
    ...
    public function faq()
    {
        $seo = [
            ...
            'og_type' => 'website',
            'image' => asset('assets/kshititech/images/faq-og.png'),
        ];
        return view('kshititech::pages.home.faq', compact('seo'));
    }
    public function testimonials()
    {
        $seo = [
            ...
            'og_type' => 'website',
            'image' => asset('assets/kshititech/images/testimonials-og.png'),
        ];
        return view('kshititech::pages.home.testimonials', compact('seo'));
    }
    public function team()
    {
        $seo = [
            ...
            'og_type' => 'website',
            'image' => asset('assets/kshititech/images/team-og.png'),
        ];
        return view('kshititech::pages.home.team', compact('seo'));
    }
    public function careers()
    {
        $seo = [
            ...
            'og_type' => 'website',
            'image' => asset('assets/kshititech/images/careers-og.png'),
        ];
        return view('kshititech::pages.home.careers', compact('seo'));
    }
    public function privacy_policy()
    {
        $seo = [
            ...
            'og_type' => 'website',
            'image' => asset('assets/kshititech/images/privacy-policy-og.png'),
        ];
        return view('kshititech::pages.home.privacy-policy', compact('seo'));
    }
    public function terms_conditions()
    {
        $seo = [
            ...
            'og_type' => 'website',
            'image' => asset('assets/kshititech/images/terms-conditions-og.png'),
        ];
        return view('kshititech::pages.home.terms-conditions', compact('seo'));
    }
}
