                ...
                <div class="container">
                    <div class="row g-4">
                        ...
                        <div class="col-md-6 col-lg-3">
                            ...
                            <ul class="list-unstyled">
                                <li>
                                    <a href="mailto:info@property.com" class="footer-link">
                                        <i class="fa fa-envelope me-2"></i>info[at]property.com
                                    </a>
                                </li>
                                <li>
                            ...
                            <div class="d-flex">
                                <a href="https://www.facebook.com/property" class="footer-link me-2"
                                    aria-label="Facebook">
                                    <i class="fab fa-facebook-f"></i>
                                </a>
                                <a href="https://www.instagram.com/property/" class="footer-link me-2"
                                    aria-label="Instagram">
                                    <i class="fab fa-instagram"></i>
                                </a>
                                <a href="https://www.linkedin.com/company/property" class="footer-link me-2"
                                    aria-label="LinkedIn">
                                    <i class="fab fa-linkedin-in"></i>
                                </a>
                                <a href="https://x.com/property" class="footer-link" aria-label="Twitter">
            ...
            <section class="footer-bottom py-3 text-center border-top border-secondary">
                <div class="container">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="https://property.com/" target="_blank" class="footer-link">
