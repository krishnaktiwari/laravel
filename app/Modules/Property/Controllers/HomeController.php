...
class HomeController extends Controller
{
    ...
    public function about_us()
    {
        $seo = [
            ...
            'og_type' => 'website',
            'image' => asset('assets/property/images/about-us-og.png'),
        ];

        return view('property::pages.home.about-us', compact('seo'));
    }
    public function contact_us()
    {
        ...
        $seo = [
            ...
            'og_type' => 'website',
            'image' => asset('assets/property/images/contact-us-og.png'),
        ];
        return view('property::pages.home.contact-us', compact('seo'));
    }
    ...
    public function portfolio()
    {
        $seo = [
            ...
            'og_type' => 'website',
            'image' => asset('assets/property/images/portfolio-og.png'),
        ];
        return view('property::pages.home.portfolio', compact('seo'));
    }
    ...
    public function faq()
    {
        $seo = [
            ...
            'og_type' => 'website',
            'image' => asset('assets/property/images/faq-og.png'),
        ];
        return view('property::pages.home.faq', compact('seo'));
    }
    public function testimonials()
    {
        $seo = [
            ...
            'og_type' => 'website',
            'image' => asset('assets/property/images/testimonials-og.png'),
        ];
        return view('property::pages.home.testimonials', compact('seo'));
    }
    public function team()
    {
        $seo = [
            ...
            'og_type' => 'website',
            'image' => asset('assets/property/images/team-og.png'),
        ];
        return view('property::pages.home.team', compact('seo'));
    }
    public function careers()
    {
        $seo = [
            ...
            'og_type' => 'website',
            'image' => asset('assets/property/images/careers-og.png'),
        ];
        return view('property::pages.home.careers', compact('seo'));
    }
    public function privacy_policy()
    {
        $seo = [
            ...
            'og_type' => 'website',
            'image' => asset('assets/property/images/privacy-policy-og.png'),
        ];
        return view('property::pages.home.privacy-policy', compact('seo'));
    }
    public function terms_conditions()
    {
        $seo = [
            ...
            'og_type' => 'website',
            'image' => asset('assets/property/images/terms-conditions-og.png'),
        ];
        return view('property::pages.home.terms-conditions', compact('seo'));
    }
}
