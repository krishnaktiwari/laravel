        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-3">
                    <h5>Quick Links</h5>
                    <ul class="list-unstyled">
                        <li><a href="{{ config('app.main_domain') }}/about-us" class="footer-link">About Us</a></li>
                        <li><a href="{{ config('app.main_domain') }}/blog" class="footer-link">Blog</a></li>
                        <li><a href="{{ config('app.main_domain') }}/faq" class="footer-link">FAQ</a></li>

                        <li><a href="{{ config('app.main_domain') }}/privacy-policy" class="footer-link">Privacy
                                Policy</a></li>
                        <li><a href="{{ config('app.main_domain') }}/terms-conditions" class="footer-link">Terms &
                                Conditions</a></li>
                        <li><a href="{{ config('app.main_domain') }}/contact-us" class="footer-link">Contact Us</a></li>
                    </ul>
                </div>
    ...
    <section class="footer-bottom py-3 text-center border-top border-secondary">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="https://sarva.one/" class="footer-link">
